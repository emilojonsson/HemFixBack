...
namespace HemFixBack.Controllers
{
    ...
    {
        private readonly IGardenTaskService _service;

        public GardenTaskController(IGardenTaskService service)
        {
            _service = service;
        }

        public IResult Create(GardenTask task)
        {
        ...
        public IResult Update(GardenTask newTask)
        {
