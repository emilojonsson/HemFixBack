...
namespace HemFixBack.Controllers
{
  ...
  {
    private readonly ISimpleTaskService _service;

    public SimpleTaskController(ISimpleTaskService service)
    {
      _service = service;
    }

    public IResult Create(SimpleTask task)
    {
    ...
    public IResult Update(SimpleTask newTask)
    {
